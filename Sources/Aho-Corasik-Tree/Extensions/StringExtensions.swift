...
public struct TrieOptions: OptionSet, Sendable {
  ...
  var trieConfig: TrieConfig {
    ...
    return TrieConfig(
      removeOverlaps: removeOverlaps, onlyDelimited: onlyDelimited,
      caseInsensitive: caseInsensitive, diacriticInsensitive: diacriticInsensitive,
      stopOnHit: stopOnHit)
  }
